  ...
  <main class="site-content site-content--projects">
    <section class="container">
      ...
      <article class="project-single">
        ...
        <p>For more info, checkout the <NuxtLink to="/posts/2019/millerbeach-comminity-air-quality-and-industry-tracker-website">blog post.</NuxtLink></p>

        <a target="_blank" href="https://millerbeach.community">
